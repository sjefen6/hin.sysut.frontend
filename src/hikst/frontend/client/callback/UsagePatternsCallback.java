...
//
//public class UsagePatternsCallback implements
...
//							// RootLayoutPanel.get().add(new NewObject(parent,
//							// usagePattern));
//						}
//
//					}));
//			usagePatternTable.setWidget(row, 1,
//					new Label(String.valueOf(usagePattern.getID())));
//			usagePatternTable.setWidget(row, 2, new Label(usagePattern.name));
//			usagePatternTable.setWidget(row, 3,
//					new Label(String.valueOf(usagePattern.actual)));
//
//			usagePatternTable.setWidget(row, 9, new Button("Modify",
//					new ClickHandler() {
//
//						@Override
//						public void onClick(ClickEvent event) {
//							// RootPanel.get().add(new
//							// NewUsagePattern(usagePattern));
//
//						}
//
//					}));
//
//			usagePatternTable.setWidget(row, 10, new Button("Duplicate",
//					new ClickHandler() {
//						@Override
//						public void onClick(ClickEvent event) {
